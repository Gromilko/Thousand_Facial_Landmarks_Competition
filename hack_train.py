...
def main(args):
    ...
    with open(f"resnet152_pretrain3ep_plus_6ep_bs160_ep8_loss1.5298880638505576_best.pth", "rb") as fp:
    ...
    for epoch in range(args.epochs):
        ...
        if val_loss <= best_val_loss:
            ...
            with open(f"{args.name}_ep{epoch}_loss{val_loss}_best.pth", "wb") as fp:
